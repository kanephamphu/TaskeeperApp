...
class RenderItem extends React.Component {
  ...
  deleteTasksave = async () => {
    ...
    await socket.emit("cl-remove-saved-task", deleteSave);
    ...
    return (
      <View style={{ marginLeft: 15 }}>
        <Text style={{ fontSize: 16, fontWeight: "bold" }}>
          {new Date(this.props.item.saved_time).toLocaleDateString()}
        </Text>
        <View style={styles.image_container}>
          ...
          >
            ...
            <View>
              ...
              >
                <TouchableOpacity
                  onPress={() => this.props.detail(this.props.item.task_id)}
                >
            ...
            >
              {this.state.show1 === false ? (
                ...
                >
                  ...
                  <TouchableOpacity
                    onPress={() => this.props.onDelete(this.props.item._id)}
                    style={{
                      width: "50%",
                      backgroundColor:
