      ...
      <View style={styles.container}>
         <View style={styles.header0}> 
            <TouchableOpacity  style={{flexDirection:'row'}}onPress={()=>this.props.navigation.navigate("Menu")}>
                ...
                <Text style={{fontWeight:'bold',fontSize:25,color:'#71B7B7',marginLeft:15,marginTop:-2}}>Jobs</Text>
            </TouchableOpacity>
        </View>
        <ScrollableTabView
          initialPage={0}
          ...
          />}
        >
          <Apply tabLabel='Apply' props={this.props}/>
          <Approve tabLabel='Approve' props={this.props}/>
        </ScrollableTabView>
      </View>
    )
  }
