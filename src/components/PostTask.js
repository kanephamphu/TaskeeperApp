...
export default class TaskPage extends React.Component {
  ...
  onSubmitImage() {
    ...
    data.append("postId", this.state.task_id);
    fetch(apiUrl, {
      method: "POST",
      body: data,
    })
  ...
  onSubmit = async () => {
    ...
    if (this.state.task_type == "freelance") {
      ...
      } else if (this.state.localUri == null) {
        e.setState({
          shownotice: true,
          notice: "Choose Image !",
          key: "error",
  ...
  handlePicker = (time) => {
    this.setState({
      show1: true,
      isVisible: false,
      choosenTime: moment(time).format("HH:mm"),
  ...
  handlePicker1 = (time) => {
    this.setState({
      isVisible1: false,
      choosenTime1: moment(time).format("HH:mm"),
  ...
  handlePicker2 = (date) => {
    this.setState({
      isVisible2: false,
      choosenTime2: moment(date).format("DD/MM/YYYY"),
      ...
      >
        <View style={styles.container}>
          ...
          >
            ...
            >
              <TouchableOpacity
                onPress={() => this.setState({ showlocation: false })}
              >
              ...
              <TouchableOpacity
                onPress={() =>
                  this.setInputLocation(
                    this.state.region.formatted_address,
          ...
          <View style={{ flex: 1, marginTop: 10 }}>
            <MapInput
              notifyChange={(loc, name) => this.getCoordsFromName(loc, name)}
            />
          </View>
      ...
      >
        <View style={styles.container}>
          ...
          >
            ...
            >
              <TouchableOpacity
                onPress={() => this.setState({ showlanguages: false })}
              >
                <View style={{ marginLeft: 10 }}>
                  <AntDesign name="close" size={24} color="black" />
                </View>
              ...
              {this.state.selectedLanguages.length == 0 ? (
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.setInputLanguage(this.state.selectedLanguages)
                  }
                >
                  <View>
                    <Text
      ...
      >
        <View style={styles.container}>
          ...
          >
            ...
            >
              <TouchableOpacity
                onPress={() => this.setState({ showindustry: false })}
              >
                <View style={{ marginLeft: 10 }}>
                  <AntDesign name="close" size={24} color="black" />
                </View>
              ...
              {this.state.selectedItems.length == 0 ? (
                ...
                <TouchableOpacity
                  onPress={() =>
                    this.setInputIndustry(this.state.selectedItems)
                  }
                >
                  <View>
                    <Text
      ...
      >
        <View style={styles.container}>
          ...
          >
            ...
            >
              ...
              {this.state.selectedSkill.length == 0 ? (
                ...
                <TouchableOpacity
                  onPress={() => this.setInputSkill(this.state.selectedSkill)}
                >
                  <View>
                    <Text
                      style={{
          ...
          <MultiSelect
            ...
            onChangeInput={(skill_query) =>
              this.onChangeValueInput(skill_query)
            }
      ...
      >
        <View style={styles.container}>
          ...
          >
            ...
            >
              <TouchableOpacity
                onPress={() => this.setState({ showtags: false })}
              >
                <View style={{ marginLeft: 10 }}>
                  <AntDesign name="close" size={24} color="black" />
                </View>
              ...
              {this.state.selectedTags.length == 0 ? (
                ...
                <TouchableOpacity
                  onPress={() => this.setInputTag(this.state.selectedTags)}
                >
                  <View>
                    <Text
                      style={{
        ...
        >
          <View style={{ flexDirection: "row" }}>
            ...
            {this.state.year < moment(daynow).format("YYYY") ? (
              <>
                {this.state.choosenTime2 == "" ? null : (
                  <View style={{ marginTop: 2, marginLeft: 10 }}>
                    <Text style={{ color: "red", fontStyle: "italic" }}>
                      Job Date isn't in the correct format !
                    </Text>
                  </View>
                )}
              </>
          ...
          <TouchableOpacity
            onPress={() => this.setState({ showlocation: true })}
          ...
          <TouchableOpacity
            onPress={() => this.setState({ showprice: true })}
            style={{ flexDirection: "row", marginTop: 20, marginLeft: 2 }}
          >
            <View style={{ position: "absolute", left: 0 }}>
            ...
            <View
              style={{ marginLeft: 50, marginTop: 2, flexDirection: "row" }}
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <View style={{ alignItems: "center" }}>
                      <View style={{ flexDirection: "row" }}>
                        <DropDownPicker
                          ...
                          onChangeItem={(price_type) =>
                            this.changePrice(price_type)
                          }
                    ...
                    {this.state.price_type === "unextract" ? (
                      ...
                      >
                        <TextInput
                          ...
                          onChangeText={(floor_price) =>
                            this.setState({ floor_price })
                          }
                        ...
                        <TextInput
                          ...
                          onChangeText={(ceiling_price) =>
                            this.setState({ ceiling_price })
                          }
                          placeholderTextColor={"grey"}
                          underlineColorAndroid="transparent"
                          multiline={true}
                    ...
                    <View style={{ alignItems: "center" }}>
                      <TouchableOpacity
                        onPress={() => this.setState({ showprice: false })}
                        style={{
                          width: "50%",
          ...
          <TouchableOpacity
            onPress={() => this.setState({ showworkingtime: true })}
            style={{ flexDirection: "row", marginTop: 20, marginLeft: 2 }}
          >
            <View style={{ position: "absolute", left: 0 }}>
            ...
            >
              ...
              >
                <View style={{ marginBottom: 20, alignItems: "center" }}>
                  <Text style={{ fontWeight: "bold", fontSize: 18 }}>
                    Please choose a time period work!
                  </Text>
                </View>
                <View style={{ flexDirection: "row" }}>
                  <TouchableOpacity
                ...
                <View style={{ alignItems: "center" }}>
                  <TouchableOpacity
                    onPress={() => this.setState({ showworkingtime: false })}
                    style={{
                      width: "50%",
                      backgroundColor: "green",
                      height: 30,
          ...
          <TouchableOpacity
            onPress={() => this.setState({ showlanguages: true })}
            style={{ flexDirection: "row", marginTop: 10, marginLeft: 2 }}
          >
            <View style={{ position: "absolute", left: 0 }}>
          ...
          {this.state.show == false ? (
            <View>
              <TouchableOpacity
                onPress={() => this.setState({ showindustry: true })}
                style={{ flexDirection: "row", marginTop: 20, marginLeft: 2 }}
              >
                <View style={{ position: "absolute", left: 0 }}>
              ...
              <TouchableOpacity
                onPress={() => this.setState({ showskill: true })}
                style={{ flexDirection: "row", marginTop: 20, marginLeft: 2 }}
              >
                <View style={{ position: "absolute", left: 0 }}>
                  <Foundation
          ...
          <TouchableOpacity
            onPress={() => this.setState({ showtags: true })}
            style={{ flexDirection: "row", marginTop: 20, marginLeft: 2 }}
          >
            <View style={{ position: "absolute", left: 0 }}>
      ...
      <View style={styles.container}>
        ...
        >
          <View style={{ backgroundColor: "#000000aa", flex: 1 }}>
            ...
            >
              <Text style={{ color: "#488B8F", fontSize: 20 }}>
                Recommended for you
              </Text>
              <FlatList
                data={this.state.dataemployee.data}
                renderItem={({ item, index }) => {
                  return (
                    <RenderItem
                      stackProfilefriend={this.showProfilefriend}
                      inviteClick={this.onInvite}
                      item={item}
                      index={index}
                      stackuser={this.props.detailuser}
                    ></RenderItem>
                  );
                }}
              ...
              ></FlatList>
              <TouchableOpacity
                onPress={() => this.setState({ showrecommendperson: false })}
                style={styles.button}
              >
        ...
        >
          ...
          >
            ...
            >
              <Image
                source={this.state.key === "success" ? iconsuccess : iconerror}
              ...
              <TouchableOpacity
                onPress={() => {
                  ...
                  {
                    this.state.key === "success" ? this.onSubmitImage() : {};
                  }
                }}
                style={{
                  width: "50%",
        ...
        >
          ...
          >
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => {
                  this.setState({ showninvite: false });
                }}
                style={{
                  width: "50%",
                  backgroundColor:
          ...
          <View style={styles.container}>
            ...
            <View style={styles.header}>
              ...
              >
                {this.state.showpost == true ? (
                  <TouchableOpacity
                    onPress={() => {
                      this.setState({ showposttask: false });
                  ...
                  <TouchableOpacity
                    onPress={() => this.setState({ showposttask: false })}
                    style={{ flexDirection: "row" }}
                  >
                    <Ionicons
                      style={{ marginTop: 1 }}
            ...
            <View style={{ marginBottom: 20 }}>
              <View style={{ flexDirection: "row" }}>
                <Avatar.Image
                  source={
                    this.state.task_owner_avatar
                      ? { uri: this.state.task_owner_avatar }
                      : null
                  }
                  size={80}
                ...
                >
                  <View style={{ flexDirection: "row", marginLeft: 2 }}>
                    <Text style={{ fontSize: 20, fontWeight: "bold" }}>
                      ...
                      {this.state.task_owner_last_name}{" "}
                    </Text>
                    {size > 0 ? (
                      <>
                  ...
                  <View style={{ flexDirection: "column" }}>
                    ...
                    >
                      {this.state.localUri == null ? (
                        ...
                        <TouchableOpacity
                          onPress={() => this.openImagePickerAsync()}
                          style={{ height: 51, width: 51, marginBottom: 10 }}
                        >
                          <Image
                    ...
                    <View>
                      ...
                      <View>
                        <TextInput
                          style={
                            this.state.showaa == true &&
                            this.state.task_title == ""
                              ? [styles.input, { borderColor: "red" }]
                              : [styles.input, { borderColor: "#D8D8D8" }]
                          }
                    ...
                    <View>
                      ...
                      <View>
                        <TextInput
                          ...
                          onChangeText={(task_requirement) =>
                            this.setState({ task_requirement })
                          }
                          placeholderTextColor={"grey"}
                          numberOfLines={5}
                          underlineColorAndroid="transparent"
        ...
        >
          <TouchableOpacity
            onPress={() => this.setState({ showposttask: true })}
          >
            <View style={{ flexDirection: "row" }}>
              <AntDesign
              ...
              />
              <AppText
                i18nKey={"home_taskpage.titlepost"}
                style={{ fontSize: 18 }}
              >
                Do you want to post new task?
              </AppText>
            </View>
          </TouchableOpacity>
        </View>
  ...
  render() {
    ...
    return (
      <View
        ...
        style={{ flex: 1, backgroundColor: "#faf9f9" }}
      >
        <View>
          <View
            style={{
          ...
          >
            ...
            >
              <View style={{ width: width - 130, flexDirection: "column" }}>
                <TouchableOpacity
                  onPress={() =>
                    this.props.stackDetail(
                      this.props.item._id,
                      this.props.item.task_owner_id
                    )
                  }
                  style={{ flexDirection: "row" }}
                >
                ...
                <View style={{ marginTop: 10, flexDirection: "row" }}>
                  ...
                  <Text style={{ color: "#696969" }}>
                    {" "}
                    {this.props.item.location.formatted_address}
                  </Text>
                </View>
                <View style={{ marginTop: 10, flexDirection: "row" }}>
                  <AppText
                    i18nKey={"home_taskpage.updated"}
                    style={{ color: "#696969" }}
                  >
                    Updated:
                  </AppText>
                ...
                <View style={{ marginTop: 10 }}>
                  {this.props.item.price.floor_price == null ? (
                    <View>
                      <Text style={{ color: "#696969" }}>
                        price: {this.props.item.price.price_type}
                      </Text>
                    </View>
                  ) : (
                    <View style={{ flexDirection: "row" }}>
                      <Text style={{ color: "#696969" }}>
                        price: {this.props.item.price.floor_price}
                      </Text>
                      <Text style={{ color: "#696969" }}>
                        {" "}
                        - {this.props.item.price.ceiling_price}
                      </Text>
                    </View>
                  )}
                </View>
...
class RenderItem extends React.Component {
  render() {
    ...
    var demcount =
      this.props.item.first_name.length + this.props.item.last_name.length;
    if (demcount >= 11) {
    ...
    return (
      <View style={styles.image_container}>
          ...
          >
            ...
            <View style={{ flexDirection: "row" }}>
              <Text style={styles.rate}>
                {this.props.item.vote_point_average.toFixed(0)}/5
              </Text>
              <Image
        ...
        <TouchableOpacity
          onPress={() => this.props.inviteClick(this.props.item.userId)}
          style={{
            width: 70,
            height: 30,
            borderRadius: 10,
