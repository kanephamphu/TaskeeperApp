            ...
            <View style={styles.container}>
                <View style={styles.body} key={this.props.item._id}>
                    ...
                    <View style={styles.bodytwo}>
                        <View style={{ flex: 1, width: 340, height: 200, borderRadius: 5, alignItems: 'center', marginRight: 10, shadowColor: 'black', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 5, shadowRadius: 3, elevation: 20 }}>
